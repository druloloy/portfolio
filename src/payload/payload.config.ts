...
export default buildConfig({
  ...
  cors: [process.env.PAYLOAD_PUBLIC_SERVER_URL || '', process.env.RAILWAY_SERVER || ''].filter(
    Boolean,
  ),
  csrf: [process.env.PAYLOAD_PUBLIC_SERVER_URL || '', process.env.RAILWAY_SERVER || ''].filter(
    Boolean,
  ),
  endpoints: [
