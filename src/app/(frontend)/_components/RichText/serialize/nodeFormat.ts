...
// lexical 0.41 no longer exposes the nodes/ subpath through its exports map.
// TextModeType comes from the root; TextDetailType is not re-exported, so it is
// reproduced here verbatim from lexical/nodes/LexicalTextNode.
